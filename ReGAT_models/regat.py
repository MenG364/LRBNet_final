...
from LR_models.language_model import WordEmbedding, QuestionEmbedding,\
                                 QuestionSelfAttention
from LR_models.relation_encoder import ImplicitRelationEncoder,\
