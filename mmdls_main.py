...
from dataset import Dictionary, VisualGenomeFeatureDataset, VQAFeatureDataset, tfidf_from_questions
...
def parse_args():
    ...
    args.expt_save_dir = os.path.join('saved_models2', args.expt_name)
    return args
...
if __name__ == '__main__':
    ...
    if args.pretrain_model != "":
        ...
        if args.dataset == "gqa":
            matched_state_dict['module.classifier.main.3.bias'] = matched_state_dict['module.classifier.main.3.bias'][
                                                                  :1852]
            matched_state_dict['module.classifier.main.3.weight_v'] = matched_state_dict[
                                                                          'module.classifier.main.3.weight_v'][:1852]
            matched_state_dict['module.left_classifier.main.3.bias'] = matched_state_dict[
                                                                           'module.left_classifier.main.3.bias'][:1852]
        ...
        if args.dataset == 'clevr':
            ...
            matched_state_dict['module.left_classifier.main.3.bias'] = matched_state_dict[
                                                                           'module.left_classifier.main.3.bias'][:28]
            matched_state_dict['module.left_classifier.main.3.weight_v'] = matched_state_dict[
                                                                               'module.left_classifier.main.3.weight_v'][
                                                                           :28]
            matched_state_dict['module.right_classifier.main.3.bias'] = matched_state_dict[
                                                                            'module.right_classifier.main.3.bias'][:28]
            matched_state_dict['module.right_classifier.main.3.weight_v'] = matched_state_dict[
                                                                                'module.right_classifier.main.3.weight_v'][
                                                                            :28]
        if args.dataset == 'vqa1.0':
            matched_state_dict['module.classifier.main.3.bias'] = matched_state_dict['module.classifier.main.3.bias'][
                                                                  :2185]
            matched_state_dict['module.classifier.main.3.weight_v'] = matched_state_dict[
                                                                          'module.classifier.main.3.weight_v'][:2185]
            matched_state_dict['module.left_classifier.main.3.bias'] = matched_state_dict[
                                                                           'module.left_classifier.main.3.bias'][:2185]
            matched_state_dict['module.left_classifier.main.3.weight_v'] = matched_state_dict[
                                                                               'module.left_classifier.main.3.weight_v'][
                                                                           :2185]
            matched_state_dict['module.right_classifier.main.3.bias'] = matched_state_dict[
                                                                            'module.right_classifier.main.3.bias'][:2185]
            matched_state_dict['module.right_classifier.main.3.weight_v'] = matched_state_dict[
                                                                                'module.right_classifier.main.3.weight_v'][
                                                                            :2185]
