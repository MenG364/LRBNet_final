...
class ImplicitRelationEncoder(nn.Module):
    def __init__(self, v_dim, q_dim, out_dim, dir_num, pos_emb_dim,
        ...
        self.edge_layer_1 = nn.Linear(in_dim, self.combined_feature_dim)
        self.edge_layer_2 = nn.Linear(self.combined_feature_dim, self.combined_feature_dim)
        self.edge_layer_3 = nn.Linear(out_dim, self.combined_feature_dim)
        self.edge_layer_4 = nn.Linear(self.combined_feature_dim, self.combined_feature_dim)
