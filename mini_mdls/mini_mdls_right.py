...
from mini_mdls.mmdls_relation_encoder_right import ImplicitRelationEncoder
...
class MMDLS_model(nn.Module):
    ...
    def forward(self, v, c, b, q, implicit_pos_emb_L, implicit_pos_emb_R, sem_adj_matrix_L=None,
        ...
        v_emb, count = self.v_relation.forward(v, b, v_mask,
        ...
        out = {'logits': (None, None, v_logits), 'q_emb': q_emb_self_att, 'att': att_r}
...
def build_mmdls_model_right(dataset, args):
    ...
    return MMDLS_model(dataset, w_emb, q_emb, q_att, cap_emb, cap_att, v_relation, joint_embedding,
                       None, None, right_classifier, None, joint_R, gamma, args.fusion,
