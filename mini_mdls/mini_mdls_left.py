...
from mini_mdls.mmdls_relation_encoder_left import ImplicitRelationEncoder
...
class MMDLS_model(nn.Module):
    ...
    def forward(self, v, c, b, q, implicit_pos_emb_L, implicit_pos_emb_R, sem_adj_matrix_L=None,
        ...
        cap_emb, count = self.v_relation.forward(q_emb_self_att, cap_emb_self_att, b, v_mask,
                                                        cap_mask,
        ...
        out = {'logits': (None, cap_logits, None), 'q_emb': q_emb_self_att, 'att': att_l}
...
def build_mmdls_model_left(dataset, args):
    ...
    return MMDLS_model(dataset, w_emb, q_emb, q_att, cap_emb, cap_att, v_relation, joint_embedding,
                       None, left_classifier, None, joint_L, None, gamma, args.fusion,
